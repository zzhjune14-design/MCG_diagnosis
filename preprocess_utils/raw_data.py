...
# 主程序
folder_path = r'D:\pythonpro\xiangmu\MCG_quexue_xinshuai\data'  # 修改为你的主文件夹路径
save_folder = r'D:\pythonpro\xiangmu\MCG_quexue_xinshuai\data_csv'  # 自定义保存路径
...
for i, subfolder in enumerate(subfolders, 1):
    ...
    raw_filename = f'raw{i}.csv'
    save_data_to_csv(raw_data, raw_filename, save_folder)
